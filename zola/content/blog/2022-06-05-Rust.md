...
date = 2022-06-05
template = "post.html"
path = "tech/programming/2022/06/05/Rust.html"
...
The serde deserialization seems to be an expensive step, so a potential avenue could be to write a custom deserializer to parse the incoming HTTP request query.
